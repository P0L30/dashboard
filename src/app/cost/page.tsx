  ...
  return (
    <div className="bg-white w-screen h-screen flex flex-col items-center relative">
      ...
      <div className="absolute top-[14vh] left-[18vw] flex justify-center items-center flex-row h-auto gap-4">
        <div className="w-[16vw] h-[8vh] rounded-xl border-slate-500 border-2 flex justify-start items-center pl-2">
          <div className="m-4">
            <svg
          ...
          <div className="mr-12">
            <p style={{ fontSize: "20px" }}>Overall Product</p>
            <p style={{ fontSize: "20px" }}>Cost</p>
          </div>
          <p style={{ fontSize: "30px" }}>135$</p>
        </div>
      </div>
      <div className="w-[80%] h-[74%] border-2 border-slate-500 rounded-3xl absolute right-[45px] top-[24vh]">
        <div className="px-[1%] py-[1%]">
          <h2>Revenue And Loss:</h2>
          <ul>
            {orders.map((order) => (
              <li
