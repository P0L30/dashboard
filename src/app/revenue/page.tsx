  ...
  return (
    <div className="bg-white w-screen h-screen flex flex-col items-center relative">
      ...
      <div className="absolute top-[14vh] left-[18vw] flex justify-center items-center flex-row h-auto gap-4">
        <div className="w-[17vw] h-[8vh] rounded-xl border-slate-500 border-2 flex justify-start items-center px-4">
          <div className="m-4">
            <svg
          ...
          <div className="mr-12">
            <p style={{ fontSize: "20px" }}>Overall Revenue</p>
          </div>
          <p style={{ fontSize: "30px" }}>1912.65$</p>
        </div>
      </div>
