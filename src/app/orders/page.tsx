    ...
    <div className="bg-white w-screen h-screen flex flex-col items-center relative">
      ...
      <div className="absolute top-[14vh] left-[18vw] flex justify-center items-center flex-row h-auto gap-4">
        <div className="w-[15vw] h-[8vh] rounded-xl border-slate-500 border-2 flex justify-start items-center pl-2">
          ...
          <div className="mr-12">
            <p style={{ fontSize: "20px" }}>Current order</p>
        ...
        <div className="w-[15vw] h-[8vh] rounded-xl border-slate-500 border-2 flex justify-start items-center pl-2">
          ...
          <div className="mr-12">
            <p style={{ fontSize: "20px" }}>Completed orders</p>
            <p style={{ fontSize: "20px" }}>count</p>
          </div>
          <p style={{ fontSize: "30px" }}>1</p>
        </div>
      </div>
      <div className="w-[80%] h-[50%] border-2 border-slate-500 rounded-3xl absolute right-[45px] top-[24vh]">
      ...
      <div className="absolute bottom-[10px] right-[50px]">
        <form onSubmit={handleNewOrder} className="space-y-4 flex flex-row">
          <div>
